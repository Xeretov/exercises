...
print('Exercise 6-11:\n')
cities: dict = {'Rome':{'country':'Italy','population':'2.8 million','fact':'Home of the Colosseum'},'Los Angeles':{'country':'California, U.S.A','population':'3.8 million','fact':'Hollywood\'s HQ'},'Singapore':{'country':'Singapore','population':'5.6 million','fact':'One of the world\'s greenest cities'}}
for i in cities.items():
    print(f"{i[0]} is a city located in {i[1]['country']} with a population of {i[1]['population']} people and it is {i[1]['fact']}")
print("")

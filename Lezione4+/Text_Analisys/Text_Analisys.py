...
def countWords(file_name: str):
    ...
    try:
        ...
        # Sort by occurances (sort iterable 'words_occurance.items()' by the value of the dictionary x[1])
        words_occurrance = dict(sorted(words_occurrance.items(), key=lambda x:x[1]))
